...
Namespace DXSample.nwindDataSetTableAdapters
	...
	Partial Public Class OrdersTableAdapter
		...
		Public Overridable Function Delete(ByVal Original_OrderID As Integer, ByVal Original_CustomerID As String, ByVal Original_EmployeeID? As Integer, ByVal Original_Freight? As Decimal, ByVal Original_ShipName As String) As Integer
		...
		Public Overridable Function Insert(ByVal CustomerID As String, ByVal EmployeeID? As Integer, ByVal Freight? As Decimal, ByVal ShipName As String) As Integer
		...
		Public Overridable Function Update(ByVal CustomerID As String, ByVal EmployeeID? As Integer, ByVal Freight? As Decimal, ByVal ShipName As String, ByVal Original_OrderID As Integer, ByVal Original_CustomerID As String, ByVal Original_EmployeeID? As Integer, ByVal Original_Freight? As Decimal, ByVal Original_ShipName As String) As Integer
			If (CustomerID Is Nothing) Then
